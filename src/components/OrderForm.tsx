          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Obsługujemy pliki PDF oraz zdjęcia (JPG, PNG). Maksymalny rozmiar pliku: 10MB
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors">
                  <Upload className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                  <p className="text-gray-600 mb-4">Przeciągnij pliki tutaj lub kliknij, aby wybrać</p>
                  <input
                    type="file"
                    multiple
                ...
                {files.length > 0 && (
                  <div className="mt-4 space-y-2">
                    <h4 className="font-medium">Wgrane pliki:</h4>
